...
def generate_pages(source_path: str, template_file_path: str, destination_path: str) -> None:
    """
    ...
    for item in os.listdir(source_path):
        ...
        if os.path.isfile(source_item_path):
            ...
            generate_page(source_item_path, template_file_path, dest_item_path)
        else:
            # Handle directories
            dest_item_path = os.path.join(destination_path, item)
            ...
            generate_pages(source_item_path, template_file_path, dest_item_path)